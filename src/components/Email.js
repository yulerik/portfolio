...
export default function Email() {
    ...
    const contentClass = `h-screen col-start-2 col-end-13 flex flex-col justify-end`
    ...
    const btnClass = `btn btn-secondary btn-outline row-start-4 row-end-5 col-start-1 col-end-3`
    const h1Class = `text-primary text-4xl`

    return (
        <div className={contentClass}>
            <h1 className={`${h1Class}`} >Contact Me</h1>
